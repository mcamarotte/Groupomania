          ...
          <b-form @submit="editUser">
            ...
            <b-form-group>
              <button
                ...
                @click="triggerInput"
                type="button">
                <span class="button-text mr-2 d-none d-md-block">Change my profile picture</span>
                <span class="button-text mr-2 d-md-none d-lg-none d-xl-none">Edit</span>
